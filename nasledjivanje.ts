...
abstract class Vozilo {
    ...
    broj_putnika: number;
    tezinaV: number;
    pr_tezina_putnika: number;
    constructor( marka_vozila: string, broj_putnika: number, tezinaV: number, pr_tezina_putnika: number) {
        this. marka_vozila =  marka_vozila;      
        this.broj_putnika = broj_putnika;
        this.tezinaV = tezinaV;
        this.pr_tezina_putnika = pr_tezina_putnika;
    }
    abstract uk_tezina_vozila(): number;
    abstract ukupna_tezina_putnika():number;
  
}
class Teretno_vozilo extends Vozilo {
    teret_vozila: number;
    constructor( marka_vozila: string, broj_putnika: number, tezinaV: number, pr_tezina_putnika: number, teret_vozila: number) {
        super( marka_vozila, broj_putnika, tezinaV, pr_tezina_putnika)
        this.teret_vozila = teret_vozila;
    }
    ukupna_tezina_putnika():number {
